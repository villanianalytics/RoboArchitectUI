var ftp = {
    name: "Ftp",
    id: "ftp",
    description: "Upload and download using FTP connection.",
    cmd: {
        linux: "RoboArchitect -ftp /type /password /passwordFile /host /port /userName /fromFile /toFile /log /logLevel",
        windows: "RoboArchitect.exe -ftp /type /password /passwordFile /host /port /userName /fromFile /toFile /log /logLevel",
        mac: "RoboArchitect -ftp /type /password /passwordFile /host /port /userName /fromFile /toFile /log /logLevel"
    },
    fields: [
        {
            label: "Type",
