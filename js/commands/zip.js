var zip = {
    ...
    cmd: {
        linux: "RoboArchitect -zip /src /destFile /log /logLevel",
        windows: "RoboArchitect.exe -zip /src /destFile /log /logLevel",
        mac: "RoboArchitect -zip /src /destFile /log /logLevel"
    },
    fields: [{
